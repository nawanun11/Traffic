...
float: right;
font-size: 16px;"> <a href="<?php echo site_url("Trafcontrol/index_dean_public_health")?>" class="btn btn-danger square-btn-adjust">หน้าหลัก</a> 
            ...
            <div class="sidebar-collapse">
				...
				<li>
                        ...
                        <ul class="nav nav-second-level">
							...
							<li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_public_health1")?>">อนามัยสิ่งแวดล้อม</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_public_health2")?>">อาชีวอนามัยและความปลอดภัย</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_public_health3")?>">สาธารณสุขศาสตร์</a>
                            </li>
