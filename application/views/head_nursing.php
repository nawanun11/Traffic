...
float: right;
font-size: 16px;"> <a href="<?php echo site_url("Trafcontrol/index_dean_nursing")?>" class="btn btn-danger square-btn-adjust">หน้าหลัก</a> 
            ...
            <div class="sidebar-collapse">
				...
				<li>
                        ...
                        <ul class="nav nav-second-level">
							...
							<li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_nursing1")?>">พยาบาลศาสตร</a>
                            </li>
