...
float: right;
font-size: 16px;"><a href="<?php echo site_url("Trafcontrol/index_dean_management")?>" class="btn btn-danger square-btn-adjust">หน้าหลัก</a> 
            ...
            <div class="sidebar-collapse">
				...
				<li>
                        ...
                        <ul class="nav nav-second-level">
                         <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_architecture1")?>">สถาปัตยกรรม</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_architecture2")?>">การออกแบบอุตสากรรม</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_architecture3")?>">การออกแบบภายใน</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_architecture4")?>">ภูมิสถาปัตยกรรม</a>
                            </li>
                </ul>
