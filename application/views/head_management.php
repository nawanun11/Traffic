            ...
            <div class="sidebar-collapse">
				...
				<li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
    		 			  <a href="<?php echo site_url("Trafcontrol/index_dean_management1")?>">บัญชี</a>
      	                      </li>
                            <li>
                          <a href="<?php echo site_url("Trafcontrol/index_dean_management2")?>">บริหารธุรกิจ</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_management3")?>">การท่องเที่ยวและการโรงแรม</a>
                                
							<li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_management4")?>">เศรษฐศาสตร์</a>
                            </li>
