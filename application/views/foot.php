  <!-- SCRIPTS -AT THE BOTOM TO REDUCE THE LOAD TIME-->
    ...
    <script src="<?php echo base_url();?>Traffic_css/assets/js/jquery.metisMenu.js"></script>
     ...
     <script src="<?php echo base_url();?>Traffic_css/assets/js/morris/raphael-2.1.0.min.js"></script>
    <script src="<?php echo base_url();?>Traffic_css/assets/js/morris/morris.js"></script>
      <!-- CUSTOM SCRIPTS -->
