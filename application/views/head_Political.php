...
float: right;
font-size: 16px;"> <a href="<?php echo site_url("Trafcontrol/index_dean_Political")?>" class="btn btn-danger square-btn-adjust">หน้าหลัก</a> 
            ...
            <div class="sidebar-collapse">
				...
				<li>
                        ...
                        <ul class="nav nav-second-level">
							...
							<li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_Political1")?>">รัฐศาสตร์</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_Political2")?>">นิติศาสตร์</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_Political3")?>">กฎหมายประยุกต์</a>
                            </li>
