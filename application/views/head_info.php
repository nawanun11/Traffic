...
float: right;
font-size: 16px;"> <a href="<?php echo site_url("Trafcontrol/index_dean_info")?>" class="btn btn-danger square-btn-adjust">หน้าหลัก</a> 
            ...
            <div class="sidebar-collapse">
				...
				<li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_info1")?>">นิเทศศาสตร์</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_info2")?>">เทคโนโลยีสารสนเทศ</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_info3")?>">มัลติมีเดียและแอนิเมชัน</a>
                                
							<li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_info4")?>">สารสนเทศดิจิทัล</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_info5")?>">วิศวกรรมซอฟต์แวร์</a>
                            </li>
