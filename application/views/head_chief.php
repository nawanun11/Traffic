    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">สมศรี มีเพียง</a> 
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;"> <a href="<?php echo site_url("Trafcontrol/index_chief")?>" class="btn btn-danger square-btn-adjust">หน้าหลัก</a> 
<a href="<?php echo site_url("Trafcontrol/login")?>" class="btn btn-danger square-btn-adjust">Logout</a> </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li>
                        <a  href="<?php echo site_url("Trafcontrol/index_chief_management1")?>"><i class="fa fa-folder-open fa-3x"></i> รายชื่อนักศึกษากระทำความผิด</a>
                    </li>
