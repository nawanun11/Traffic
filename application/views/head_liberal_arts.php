...
float: right;
font-size: 16px;"> <a href="<?php echo site_url("Trafcontrol/index_dean_liberal_arts")?>" class="btn btn-danger square-btn-adjust">หน้าหลัก</a> 
            ...
            <div class="sidebar-collapse">
				...
				<li>
                        ...
                        <ul class="nav nav-second-level">
							...
							<li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_liberal_arts1")?>">ภาษาอังกฤษ</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_liberal_arts2")?>">ภาษาจีน</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_liberal_arts3")?>">อาเซียนศึกษา</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url("Trafcontrol/index_dean_liberal_arts4")?>">ไทยศึกษาบูรณาการ</a>
                            </li>
